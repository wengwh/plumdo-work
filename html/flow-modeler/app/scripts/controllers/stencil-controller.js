...
angular.module('flowableModeler')
    .controller('StencilController', ['$rootScope', '$scope', '$http', '$modal', '$timeout', '$window', 'editorManager',
        ...
        $scope.editorFactory.promise.then(function () {
            ...
            var quickMenuDefinition = ['UserTask', 'CallActivity', 'EndNoneEvent', 'ExclusiveGateway', 'ParallelGateway', 'InclusiveGateway', 'TextAnnotation', 'SequenceFlow'];
            ...
            if(stencilItemGroups.length > 0){
              stencilItemGroups[0].expanded = true;
            }
